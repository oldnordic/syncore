...
use crate::project_analysis::{
    PAEResponse, ProjectAnalysisEngine, RefactorKind, RefactorSuggestion,
};
use anyhow::Result;
...
impl ProjectAnalysisEngine {
    ...
    pub async fn refactor_suggestions(
        &self,
        request: RefactorSuggestionsRequest,
    ) -> Result<PAEResponse<RefactorSuggestionsData>> {
    ...
    async fn generate_refactor_suggestions(
        &self,
        request: RefactorSuggestionsRequest,
    ) -> Result<RefactorSuggestionsData> {
