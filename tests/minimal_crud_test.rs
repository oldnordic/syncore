// Minimal test that bypasses all broken modules and tests core functions directly
use syncore::{taskmaster, cognitive_db, vector};
use rusqlite::Connection;
use std::fs;

#[test]
fn test_minimal_task_crud() {
    let test_db = "minimal_test.db";
...
#[test]
fn test_minimal_cognitive_crud() {
    let test_db = "minimal_cognitive_test.db";
    let _ = fs::remove_file(test_db);
...
#[test]
fn test_minimal_vector_operations() {
    // Setup vector store
