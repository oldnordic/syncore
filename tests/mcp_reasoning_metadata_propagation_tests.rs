...
async fn test_raggraph_query_metadata_exists() -> Result<()> {
    ...
    let request = RagGraphQueryInput {
        query_text: "find authentication functions".to_string(),
    };
    ...
    assert!(response.get("metadata").is_some(), "Response should contain 'metadata' field");
...
async fn test_metadata_backend_used_sqlitegraph() -> Result<()> {
    ...
    let request = RagGraphQueryInput {
        query_text: "test query for metadata".to_string(),
    };
...
async fn test_metadata_parameters_with_defaults() -> Result<()> {
    ...
    let request = RagGraphQueryInput {
        query_text: "test parameters".to_string(),
    };
    ...
    assert!(parameters.contains_key("query"), "metadata.parameters should contain 'query' key");
...
async fn test_metadata_timestamps_valid() -> Result<()> {
    ...
    let request = RagGraphQueryInput {
        query_text: "test timestamps".to_string(),
    };
    ...
    assert!(start_time <= current_time, "metadata.start_time_ms should not be in the future");
...
async fn test_metadata_vector_search_timing_present() -> Result<()> {
    ...
    let request = RagGraphQueryInput {
        query_text: "semantic search test".to_string(),
    };
    ...
    assert!(vector_search_time > 0, "metadata.vector_search_ms should be greater than 0");
...
async fn test_metadata_deterministic_behavior() -> Result<()> {
    ...
    let request = RagGraphQueryInput {
        query_text: "deterministic test".to_string(),
    };
...
async fn test_multihop_metadata_timing_fields() -> Result<()> {
    ...
    assert!(graph_traversal_time > 0, "metadata.graph_traversal_ms should be greater than 0");
