...
fn test_cognitive_state_sequence() {
    ...
    steps.push(CogStep::new(CogState::Think, "Analyze performance bottleneck".to_string(), Some(1)));
    ...
    steps.push(CogStep::new(CogState::Reflect, "Goal achieved, task complete".to_string(), Some(1)));
